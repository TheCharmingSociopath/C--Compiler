...
public:
    ...
    ASTFor(ASTExpr *_initExpr, ASTExpr *_conditionExpr, ASTExpr *_incrementExpr, ASTBlock *_block) : initExpr(_initExpr),
    conditionExpr(_conditionExpr), incrementExpr(_incrementExpr), block(_block) {}
...
public:
    ASTIfElse(ASTExpr *_expr, ASTBlock *_ifBlock, ASTBlock *_elseBlock) : expr(_expr), ifBlock(_ifBlock), elseBlock(_elseBlock) {}
...
public:
    ASTTernary (ASTExpr *_expr, ASTStat *_stat1, ASTStat *_stat2) : expr(_expr), stat1(_stat1), stat2(_stat2) {}
...
public:
    ...
    ASTVariableList(ASTType* type, vector<ASTDeclare*> identifierList) : type(type), identifierList(identifierList) {}
    ASTType* getType()
    {
        return type;
    }
...
class ASTDeclare : public ASTnode
{
    ...
    ASTExpr* val;
public:
    ASTDeclare(std::string identifier, std::string op, ASTExpr* val) : identifier(identifier), op(op), val(val) {}
    string getIdentifier()
    {
        return identifier;
    }
...
public:
    ASTLiteralInt(int intlit) : intlit(intlit) {}
...
public:
    ASTLiteralFloat(float floatlit) : floatlit(floatlit) {}
...
public:
    ASTLiteralString(string stringlit) : stringlit(stringlit) {}
...
public:
    ASTLiteralChar(char charlit) : charlit(charlit) {}
...
public:
    ASTLiteralBool(bool boollit) : boollit(boollit) {}
...
class ASTLocationIdentifier : public ASTnode
{
    string identifier;
public:
    ASTLocationIdentifier(string identifier) : identifier(identifier) {}
...
class ASTLocationIdentifierArray : public ASTnode
{
    ...
    ASTExpr *expr;
public:
    ASTLocationIdentifierArray(string identifier, ASTExpr *_expr) : identifier(identifier), expr(_expr) {}
...
public:
    ASTLocationIdentifierDoubleArray(string identifier, ASTExpr *_expr1, ASTExpr *_expr2) : identifier(identifier), expr1(_expr1), expr2(_expr2) {}
...
class ASTControl : public ASTnode
{
    ...
    ASTExpr *expr;
public:
    ASTControl(std::string command, ASTExpr *_expr) : command(command), expr(_expr) {}
    ASTExpr *getExpr()
    {
        return expr;
    }
...
public:
    ...
    ASTExprUnaryOp(std::string op, ASTExpr *_node) : unary_operator(op), expr(_node) {}
...
public:
    ASTExprIdentifier(string identifier) : identifier(identifier) {}
